...
import { ArrowRight, BrainCircuit, DollarSign, Gem, Share2, Swords, Target, Users } from "lucide-react";
...
export default function FreeDashboard({ setActiveView, currentPlan }: DashboardProps) {
  if (currentPlan === 'pro') {
      return (
